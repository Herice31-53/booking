                                            ...
                                            foreach($days as $key => $value)
                                            {
                                                ...
                                                if(in_array($key,$av_days))
                                                {
                                                    ...
                                                    foreach($employees as $employee)
                                                    {
                                                        ...
                                                        {
                                                            echo "<div class='time_ col-md-10 row'>";
                                                            echo "<div class='form-group col-md-2'>";
                                                            ...
                                                            <div class='form-group col-md-1.5'>
                                                                <label class='day-name'>Break:</label>
                                                            </div>
                                                            <?php
                                                            echo "<div class='form-group col-md-2'>";
                                                            echo "<input type='time' name='".$value."-break_begin' value='".$employee['break_begin']."'  class='form-control'>";
                                                            echo "</div>";
                                                            echo "<div class='form-group col-md-2'>";
                                                            echo "<input type='time' name='".$value."-break_end' value='".$employee['break_end']."'  class='form-control'>";
                                                            echo "</div>";
                                                            echo "</div>";
                                                ...
                                                else
                                                {
                                                    ...
                                                    echo "</span>";
                                                    echo "</div>";                             
                                                    echo "<div class='time_ col-md-10 row' style='display:none;'>";
                                                    echo "<div class='form-group col-md-2'>";
                                                    ...
                                                    <?php
                                                    echo "<div class='form-group col-md-2'>";
                                                    echo "<input type='time' name='".$value."-break_begin' value = '12:00' class='form-control'>";
                                                    echo "</div>";
                                                    echo "<div class='form-group col-md-2'>";
                                                    echo "<input type='time' name='".$value."-break_end' value = '13:00' class='form-control'>";
                                                    echo "</div>";
                                                    echo "</div>";
                        ...
                        if(isset($_POST['save_schedule_sbmt']))
                        {
                            ...
                            foreach($days as $key=>$value)
                            {
                                ...
                                {   
                                    ...
                                    $stmt = $con->prepare("insert into employees_schedule(employee_id,day_id,from_hour,to_hour,break_begin,break_end) values(?, ?, ?, ?, ?, ?)");
                                    $stmt->execute(array($_POST['employee_id'],$key,$_POST[$value.'-from'],$_POST[$value.'-to'],$_POST[$value.'-break_begin'],$_POST[$value.'-break_end']));
                                    ...
                                    ?>
                                        ...
                                        <script type="text/javascript">
                                            swal("Set Employee Schedule","You have successfully set the employee schedule!", "success"); 
                                        </script>
